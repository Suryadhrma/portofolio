...
export const listProyek = [
  {
    ...
    gambar: ProyekSuhu,
    nama: "SUHU",
    desk: "Mencari teknisi AC yang datang cepat dengan harga transparan masih sulit dilakukan lewat WhatsApp atau rekomendasi acak. Sebagai Backend Developer, saya membangun REST API-nya dari nol hingga deploy — database, state machine status order, sampai integrasi payment gateway.",
  ...
  },
  {
    ...
    gambar: ProyekRinci,
    nama: "Rinci",
    desk: "Mengubah dokumen bisnis yang berantakan — struk, invoice, hasil scan — jadi data terstruktur masih dikerjakan manual dan rawan salah. Saya membangun backend service ekstraksi dokumen (masih dalam pengembangan) dengan NestJS dan Gemini API, diuji pada dataset CORD-v2 dengan akurasi 90.1%.",
